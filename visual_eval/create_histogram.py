...
def create_histogram(filename, iterations, stepsize, x_label, y_label, max_x,
    ...
    ani = animation.FuncAnimation(
        fig, animate,
        fargs=[x_data, y_data, fig, min_y, max_y, x_label, y_label, title, iterations],
        interval=100
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("-s", "--stepsize", help="stepsize for the animation",
                        type=int)
    parser.add_argument("-i", "--iterations", help="number of iterations shown",
                        type=int)
    ...
    create_histogram(args.filename, args.iterations, args.stepsize,
                     ...
                     args.min_bound_y, args.max_bound_y, args.title)
